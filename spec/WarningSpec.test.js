...
import Warning, { highlightStyles, setNodeStyle, calculateCoords } from '../src/components/Warning.js';
...
describe('#calculateCoords', () => {
  ...
  it('should return valid coords when both parentNode and rangeToHighlight are valid', () => {
    ...
    expect(calculateCoords(parentNode, rangeToHighlight)).toEqual({ top: 65, left: 0 })
  })
})
