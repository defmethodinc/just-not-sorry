  ...
  warnings: [
    ...
    },
    {
      ...
      source:
        'http://www.taramohr.com/8-ways-women-undermine-themselves-with-their-words/',
      message:
        '"Actually" communicates a sense of surprise that you have ' +
    ...
    },
    {
      ...
      message:
        'Using "sorry" frequently undermines your gravitas and makes you ' +
    ...
    },
    {
      ...
      source:
        'http://www.fastcompany.com/3032112/strong-female-lead/sorry-not-sorry-why-women-need-to-stop-apologizing-for-everything',
      message:
        'Apologizing unnecessarily puts you in a subservient position and ' +
    ...
    },
    {
      ...
      message:
        '"I think" undermines your idea and displays an overall lack of ' +
        'self-confidence. --Lydia Dishman',
    },
    {
      keyword:
        "I'm no expert|We're no expert|We're no experts|We're not experts",
      source:
        'http://www.fastcompany.com/3049609/the-future-of-work/4-types-of-useless-phrases-you-need-to-eliminate-from-your-emails',
      message:
        '"I\'m no expert" undermines your idea and displays an overall ' +
    ...
    },
    {
      ...
      message:
        'The "Yes, but" syndrome is entirely counterproductive, particularly in a work setting. ' +
    ...
    },
    {
      ...
      message:
        'If something is literal, your readers should know it without you needing to use this word to clarify it. ' +
    ...
    {
      keyword:
        'does that make sense|did that make sense|does this make sense|did this make sense',
      source: 'http://goop.com/how-women-undermine-themselves-with-words/',
      message:
        '"does that make sense" comes across either as condescending ' +
    ...
    },
    {
      ...
      source:
        'http://www.lifehack.org/articles/communication/7-things-not-to-say-and-7-things-to-start-saying.html',
      message:
        'The word "should" is inherently negative. "Should" implies a lose: lose ' +
    ...
    },
    {
      ...
      message:
        'If you write an opinion, the reader understands that you also ' +
        'believe it is right. ' +
        '--David Bowman',
    },
    {
      ...
      message:
        'Phrases containing "we believe," "we think," and "we feel" pervade ' +
    ...
    },
    {
      ...
      source:
        'http://101books.net/2012/03/02/7-annoying-words-that-should-die-a-horrible-death/',
      message:
        "I think what you're saying is that you said something. If " +
    ...
    },
    {
      ...
      source:
        'http://www.vogue.com/13362056/things-working-women-should-never-email/',
      message:
        'Like they said in school, there are no stupid ' +
    ...
    },
    {
      ...
      source:
        'http://www.vogue.com/13362056/things-working-women-should-never-email/',
      message:
        "Don't lessen the impact of what you say before " +
        'you say it. --Alexandra Macon',
    },
    {
      keyword:
        "I'm just being honest here|If I'm being honest|Honestly|to be honest|if I'm honest|to be perfectly honest|in all honesty",
      source:
        'https://lifehacker.com/the-verbal-tee-ups-that-often-reveal-dishonesty-1505870461',
      message:
        'Tee-ups like this may make the reader shut down and respond negatively to your comment.',
    },
    {
      keyword: 'I guess',
      source:
        'https://www.inc.com/mary-rezek/cut-kinda-sorta-i-guess-how-to-end-your-filler-word-bad-habits.html',
      message:
        'If you\'re sure of something, "guessing" detracts from your message and opens doubt in the reader\'s mind.',
    },
    {
      keyword: 'Maybe',
      source:
      ...
      message:
        'By adding "maybe" to your sentence, it makes it seem like you aren\'t confident in your answer/suggestion. Say what you mean. If you mean no, say no, if you mean yes, say yes.',
    },
    {
      keyword: '!!!',
      source:
        'https://www.theatlantic.com/technology/archive/2018/06/exclamation-point-inflation/563774/?utm_source=feed',
      message:
        "We get it, you're excited!!! Use that many exclamation points with your friends," +
